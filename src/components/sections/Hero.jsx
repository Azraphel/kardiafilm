...
// Vidéo de fond : place ton fichier dans /public/vid/hero.mp4
// Si le fichier n'existe pas, le gradient animé prend le relais automatiquement.
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: '860px', width: '100%', textAlign: 'center' }}>
        ...
        <div className="fade-in-up" style={{ transitionDelay: '160ms' }}>
          <p style={{
            ...
            maxWidth: '580px', margin: 'clamp(1.25rem,3vw,2rem) auto 0',
          }}>
        ...
        <div className="fade-in-up" style={{
          ...
          flexWrap: 'wrap', marginTop: 'clamp(1.75rem,4vw,2.5rem)',
        }}>
        ...
        <div className="fade-in-up" style={{ transitionDelay: '320ms', marginTop: 'clamp(2.5rem,5vw,4rem)' }}>
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{
                padding: 'clamp(1rem,2.5vw,1.375rem) 0.75rem', textAlign: 'center',
                borderRight: i < 2 ? '1px solid rgba(255,255,255,0.08)' : 'none',
              }}>
                <div className="stat-shimmer" style={{ fontSize: 'clamp(0.95rem,2.5vw,1.35rem)', fontWeight: 800, letterSpacing: '-0.02em' }}>
                  {item.val}
                </div>
                <div style={{ fontSize: 'clamp(0.55rem,1.2vw,0.65rem)', color: 'rgba(255,255,255,0.45)', fontFamily: 'monospace', letterSpacing: '0.06em', marginTop: '0.2rem' }}>
                  {item.sub}
                </div>
              </div>
            ))}
